...
/**
 * Created by Ryan on 17/06/2017.
 */

public class RegisterSupermarketFragment extends BaseFragment {
    public static final String TAG = "PopopQuestionFragment";

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        parentView = bindXMLToFragment(R.layout.register_view, inflater, container);
